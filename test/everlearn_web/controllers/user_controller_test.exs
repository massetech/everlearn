defmodule EverlearnWeb.UserControllerTest do
  use EverlearnWeb.ConnCase

  alias Everlearn.Members

  @create_attrs %{email: "some email", main_language: "some main_language", provider: "some provider", role: "some role", token: "some token"}
